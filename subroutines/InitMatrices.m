function [snapshot,plotst,cnt_atm,snp_atm,cnt_ocn,snp_ocn,Mb_update,Li,Lj, ...
    dtdx,dtdx2,X,Y,x,y,MASK,H,Ho,B,Bo,glMASK0,MASKo,Mb,Ts,As,G,u,VAF,VA0,POV, ...
...
% Initialization of main matrices used in the model
    ...
    [H,Ho,B,Bo,Mb,Ts,u,dSLR,CMB,FMB,Tof,Sof,TFf,Tsf,Mbf,Prf,Evpf, ...
        runofff,Melt,glMASK0,Dbw,Melt_mean,Bmelt_mean,Ts_mean,Mb_mean, ...
        To_mean,So_mean,TF_mean,CR_mean,FMR_mean,fluxmx_mean,fluxmy_mean, ...
        Smelt_mean,runoff_mean,rain_mean,acc_mean]=deal(zeros(ctr.imax,ctr.jmax));
    Mb=Mb+ctr.MbConst;
    Ts=Ts+ctr.TsConst;
