function [snapshot,plotst,cnt_atm,snp_atm,cnt_ocn,snp_ocn,Mb_update,Li,Lj, ...
    dtdx,dtdx2,X,Y,x,y,MASK,H,Ho,B,Bo,glMASK0,MASKo,Mb,Ts,As,G,u,ub,ubx,uby,VAF,VA0,POV, ...
...
% Initialization of main matrices used in the model
    ...
    [H,Ho,B,Bo,Mb,Ts,u,ub,ubx,uby,dSLR,CMB,FMB,Tof,Sof,TFf,Tsf,Mbf,Prf,Evpf, ...
