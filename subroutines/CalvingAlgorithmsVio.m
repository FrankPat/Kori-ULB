function [CMB,LSF,CR]=CalvingAlgorithmsVio(ctr,par,dudx,dvdy,dudy,dvdx,glMASK,H,A, ...
...
if ctr.calving>=1 % LSF function calving. Generate a calving rate, CR
    ...
    if ctr.calving==5 || ctr.calving==4 || ctr.calving==6 || ctr.LimitFront==1
