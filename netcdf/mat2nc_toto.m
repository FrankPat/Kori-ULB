...
function mat2nc(input,output,dx)
    ...
    % --- General variables ----
    variables = ["uxssa" "uyssa"...
	         "u" "ux" "uy" ...
                 "H" "Ho" "B" "Bo" "Bor"...
                 "MASK" "MASKo" "Db" "G"...
                 "Btau" "Mb" "Ts" "Pr" "Evp"...
                 "To" "So" "ZB" "Bmelt" "Melt"...
		 "A" "eta" "dudx" "dudy" "dvdx" "dvdy" "damage" "scale_eta"];
    
    stnd_name = ["Horizontal integrated velocity (SSA)" "Vertical integrated velocity (SSA)"...
	         ...
	         "Ice thickness" "Observed ice thickness" "Bedrock elevation (saturated)" "Observed bedrock elevation" "Bedrock elevation"...
                 "Ice mask" "Observed ice mask" "Lithospheric thickness" "Geothermal heatflow"...
    ...
    long_name = ["Horizontal integrated velocity (SSA)" "Vertical integrated velocity (SSA)"...
                 "Surface velocity" "Horizontal surface velocity" "Vertical surface velocity" ... 
	         "Ice thickness" "Observed ice thickness" "Bedrock elevation (saturated)" "Observed bedrock elevation" "Bedrock elevation"...
                 "Ice mask (grounded = 1; floating = 0)" "Observed ice mask (invariable in time)" "Flexural rigidity of the lithosphere" "Geothermal heatflow"...
                 "Asthenosphere relaxation time" "Surface mass balance" "Mean annual surface temperature" "Annual precipitation" "Evaporation"...
                 "Ocean temperature" "Ocean salinity" "Zwally basins" "Basal melt" "Basal melt (grounded)"...
		 "" "" "" "" "" "" "Damage" "Damage parcent (eta scale)"];
    ...
    units      = ["m/yr" "m/yr"...
	          ...
	          "m" "m" "m" "m" "m"...
                  ...
                  "?" "m a-1" "degC" "?" "?"...
                  "degC" "PSU" "" "m/yr" "m/yr"...
		  "Pa-3 yr-1?" "Pa yr" "m/yr" "m/yr" "m/yr" "m/yr" "" "%"];
